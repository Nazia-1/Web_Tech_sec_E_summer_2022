...
<input type="text" name="name" value="<?php echo $name;?>"placeholder="Enter your Name"><span class="error">* <?php echo $nameE;?> </span><br>
...
<input type="text" name="email" value="<?php echo $email;?>"placeholder="Enter your Email address"><span class="error">* <?php echo $emailE;?></span><br>
<hr style="border: 0.1px solid;">
